...
parser = argparse.ArgumentParser(description='999 Dice Bot | This Is Gambling Bot Please Take Own Your Risk')
parser.add_argument(
    '-c','--betset',
    default=0,
...
"+hijau+"Profit "+res+str(prof))
    ...
    if float(js["Doge"]["Balance"])/(10 ** 8) > float(5000.00000000):
        print (hijau+"\
\
